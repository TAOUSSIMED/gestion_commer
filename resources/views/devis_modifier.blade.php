...
<form action = "/devis/accepted/{{$dev->id}}" method = "post" class="form-horizontal form-label-left">
@csrf <!-- {{ csrf_field() }} -->
...
<div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="text" class="form-control" placeholder="Solution" name="solution"value="{{$dev->solution}}">
                        </div>
                    </div>
                    <div class="form-group">
