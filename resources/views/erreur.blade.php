    ...
    <div class="outer">
        <div class="middle">
            <div class="inner">
                ...
                <span class="inner-status">Erreur de Saisie </span>
                <span class="inner-detail">verifier votre saisie s'il vous plait </span>
                <span class="inner-detail"><a href="/bon_commande">BACK</a></span>
                <!--END CONTENT-->
            </div>
        </div>
    </div>
