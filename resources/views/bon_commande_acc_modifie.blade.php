...
<form action = "/ligne_bon_commande/accepted/{{$dev->id}}" method = "post" class="form-horizontal form-label-left">
@csrf <!-- {{ csrf_field() }} -->
...
<div class="col-md-9 col-sm-9 col-xs-12">
  ...
  <option value="{{$dev->bon_commande_id}}">{{$dev->bon_commande_id}}</option>
  <option value="Aucune">..........</option>
   @foreach ($boncommandes as $devi)
